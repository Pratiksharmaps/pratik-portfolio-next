    ...
    skills: [
      {
        ...
        desc: 'Custom CMS & Ecommerce',
        usage: 'Built multiple custom ecommerce platforms and corporate sites with customized WooCommerce checkout pipelines',
        proficiency: 5,
      },
      {
        name: 'Hosting & VPS Management',
        level: 85,
        icon: 'https://cdn.simpleicons.org/godaddy/1B1B1B',
        desc: 'GoDaddy, VPS, business emails',
        usage: 'Deploying websites to secure VPS instances, managing GoDaddy services, configuring domains, SSL certificates, and business emails',
        proficiency: 4,
      },
      {
        name: 'Payment Gateways',
        level: 88,
        icon: 'https://cdn.simpleicons.org/razorpay/0B72E7',
        desc: 'Razorpay, PhonePe integrations',
        usage: 'Implemented end-to-end secure payment gateway processing for clients in WooCommerce and custom mobile checkouts',
        proficiency: 5,
      },
      {
        name: 'Digital Marketing & SEO',
        level: 80,
        icon: 'https://cdn.simpleicons.org/googleanalytics/E1700F',
        desc: 'SEO audits, ranking growth',
        usage: 'Performed site auditing, configured Google Search Console / Analytics, and optimized SEO structure to grow organic search traffic',
        proficiency: 4,
      },
    ],
  },
